...
import { Sparkles, Mail, ArrowRight, CheckCircle, Building2 } from 'lucide-react';
...
export default function VenueVerifyEmail() {
  ...
  return (
    <div className="min-h-screen w-full bg-background overflow-hidden relative flex items-center justify-center p-4">
      {/* Animated background - Primary theme for venues */}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Step label */}
        <p className="text-center text-sm text-muted-foreground mb-4">Step 3 of 9</p>
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              <h1 className="text-2xl lg:text-3xl font-bold text-foreground mb-2">
                {verified ? 'Business Email Verified!' : 'Verify Business Email'}
              </h1>
              <p className="text-muted-foreground">
                {verified 
                  ? 'Redirecting to phone verification...'
                  : `Enter the 6-digit code sent to ${venueEmail}`
                }
              </p>
            </div>

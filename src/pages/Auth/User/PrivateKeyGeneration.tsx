...
export default function UserPrivateKeyGeneration() {
  ...
  return (
    <div className="min-h-screen w-full bg-background overflow-hidden relative flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gold/5 rounded-full blur-3xl animate-float" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-xl">
        ...
        <p className="text-center text-sm text-muted-foreground mb-4">Step 5 of 5</p>
          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-gold via-orange to-pink flex items-center justify-center shadow-lg shadow-gold/30">
                  {complete ? (
                ...
                <div className="absolute -inset-1 bg-gradient-to-br from-gold via-orange to-pink rounded-2xl blur opacity-40 animate-pulse" />
              </div>
            </div>
            ...
            <div className="text-center mb-6">
              <h1 className="text-2xl lg:text-3xl font-bold text-foreground mb-2">
                {complete ? 'Wallet Created!' : 'Your Recovery Phrase'}
              </h1>
              ...
              <>
                ...
                <div className="mb-6 p-4 rounded-xl bg-orange/10 border border-orange/30">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      <p className="font-medium text-orange mb-1">Critical Security Information</p>
                      <p className="text-muted-foreground">
                        This phrase is the ONLY way to recover your wallet. Store it securely offline. 
                        Never share it with anyone, including Joint Vibe support.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {generating ? (
                  <div className="p-8 rounded-xl bg-secondary/50 border border-border flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm text-muted-foreground">Generating secure recovery phrase...</p>
                  </div>
                ) : (
                  <div className="relative">
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex gap-3">
                      <Button
                        variant="outline"
                        onClick={handleCopy}
                        className="flex-1 gap-2 border-cyan/50 text-cyan hover:bg-cyan/10"
                      >
                    ...
                    <label className="flex items-start gap-3 p-4 rounded-xl bg-secondary/30 border border-border cursor-pointer hover:bg-secondary/50 transition-colors">
                      <input
                        ...
                        className="mt-1 w-5 h-5 rounded border-border text-gold focus:ring-gold"
                      />
                      <span className="text-sm text-muted-foreground">
                        I have securely stored my 12-word recovery phrase and understand that 
                        Joint Vibe cannot recover my wallet if I lose it.
                      </span>
                    </label>
                    ...
                    <Button 
                      ...
                      className="w-full h-12 rounded-xl bg-gradient-to-r from-gold via-orange to-pink hover:opacity-90 text-white font-semibold transition-all duration-300 group"
                      disabled={!confirmed}
                    >
